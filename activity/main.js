...
async function pdfconverter(){
    ...
    await tab.goto("C:\\Hospital_Geolocator\\activity\\Utilities\\Information\\details.html",{
        waitUntil:"load"
    })
    await tab.pdf({ path: './hospital_details.pdf'}); 
    browser.close();
}
...
(async function () {
    try {
        ...
        // Send Mail
        await gmailsendFnObj.gmailsendFn(recieverEmail);
