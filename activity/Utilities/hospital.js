	...
	try {
        ...
        for (let i = 0; i < hospital_namesArr.length; i++){
            ...
            function browserInfoConsole() {
                ...
                let h_rating = document.querySelector("span.Aq14fc").innerText;
                let h_number = document.querySelector(".LrzXr.zdqRlf.kno-fv").innerText;
                let h_address = document.querySelector(".Z1hOCe").innerText;
                let h_openTimings = document.querySelector("div.bJpcZ").innerText;
